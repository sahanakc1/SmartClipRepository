...
var Calendar = {
    ...
    _drawMonths: function(){
        ...
        var i;
        for(i = 0; i < 12; i++) {
            $("<li>").addClass("js-month-"+i).html(calendar_locale['months']).appendTo(list);
        }
    },
...
var DatePicker = {
    ...
    _createStructure: function(){
        ...
        if (o.month === true) {
            ...
            for (i = 0; i < 12; i++) {
                $("<li>").addClass("js-month-"+i+" js-month-real-"+this.locale['months'].toLowerCase()).html(this.locale['months']).data("value", i).appendTo(month);
            }
            for (i = 0; i < o.distance; i++) $("<li>").html("&nbsp;").data("value", -1).appendTo(month);
        }
        ...
        if (o.copyInlineStyles === true) {
            for (i = 0; i < element[0].style.length; i++) {
                picker.css(element[0].style, element.css(element[0].style));
            }
        }
    ...
    _create: function(){
        ...
        if (o.copyInlineStyles === true) {
            for (var i = 0, l = element[0].style.length; i < l; i++) {
                container.css(element[0].style, element.css(element[0].style));
            }
        }
...
var Keypad = {
    ...
    _createKeypad: function(){
        ...
        if (o.copyInlineStyles === true) {
            for (var i = 0, l = element[0].style.length; i < l; i++) {
                keypad.css(element[0].style, element.css(element[0].style));
            }
        }
...
var Rating = {
    ...
    _createRating: function(){
        ...
        if (o.copyInlineStyles === true) {
            for (i = 0; i < element[0].style.length; i++) {
                rating.css(element[0].style, element.css(element[0].style));
            }
        }
...
var Slider = {
    ...
    _createSlider: function(){
        ...
        if (o.copyInlineStyles === true) {
            for (i = 0; i < element[0].style.length; i++) {
                slider.css(element[0].style, element.css(element[0].style));
            }
        }
