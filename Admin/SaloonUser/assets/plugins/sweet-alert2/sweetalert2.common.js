...
var getChildByClass = function getChildByClass(elem, className) {
  for (var i = 0; i < elem.childNodes.length; i++) {
    if (hasClass(elem.childNodes, className)) {
...
var animationEndEvent = function () {
  ...
  for (var i in transEndEventNames) {
    if (transEndEventNames.hasOwnProperty(i) && testEl.style !== undefined) {
      return transEndEventNames;
    }
  }
...
var modalDependant = function modalDependant() {
  ...
  return new Promise(function (resolve, reject) {
    ...
    for (var i = 0; i < buttons.length; i++) {
      buttons.onclick = onButtonEvent;
      buttons.onmouseover = onButtonEvent;
      buttons.onmouseout = onButtonEvent;
      buttons.onmousedown = onButtonEvent;
    }
  ...
  return new Promise(function (resolve, reject) {
    (function step(i, callback) {
      if (i < queue.length) {
        ...
        sweetAlert(queue).then(function (result) {
