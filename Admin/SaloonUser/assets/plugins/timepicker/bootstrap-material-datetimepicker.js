   ...
   Plugin.prototype =
           {
              ...
              constructHTMLCalendar: function (date, calendar)
              {
                 ...
                 {
                    _template += '<th>' + moment(parseInt(calendar.week), "d").locale(this.params.lang).format("dd").substring(0, 1) + '</th>';
                 }
                 ...
                 for (var i = 0; i < calendar.days.length; i++)
                 {
                    if (i % 7 == 0)
                       _template += '</tr><tr>';
                    _template += '<td data-date="' + moment(calendar.days).locale(this.params.lang).format("D") + '">';
                    if (calendar.days != 0)
                    {
                        if (this.isBeforeMaxDate(moment(calendar.days), false, false) === false
                            || this.isAfterMinDate(moment(calendar.days), false, false) === false
                            || this.params.disabledDays.indexOf(calendar.days.isoWeekday()) !== -1)
                        {
                            _template += '<span class="dtp-select-day">' + moment(calendar.days).locale(this.params.lang).format("DD") + '</span>';
                        } else
                        {
                            if (moment(calendar.days).locale(this.params.lang).format("DD") === moment(this.currentDate).locale(this.params.lang).format("DD"))
                            {
                                _template += '<a href="javascript:void(0);" class="dtp-select-day selected">' + moment(calendar.days).locale(this.params.lang).format("DD") + '</a>';
                            } else
                            {
                                _template += '<a href="javascript:void(0);" class="dtp-select-day">' + moment(calendar.days).locale(this.params.lang).format("DD") + '</a>';
                            }
                        }
              ...
              _detachEvents: function ()
              {
                 ...
                 {
                    this._attachedEvents[0].off(this._attachedEvents[1], this._attachedEvents[2]);
