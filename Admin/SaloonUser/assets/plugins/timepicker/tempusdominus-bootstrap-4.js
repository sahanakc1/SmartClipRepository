    ...
    var DateTimePicker = function () {
            ...
            if (this._isValid(targetMoment)) {
                ...
                if (this._options.allowMultidate && this._dates.length > 1) {
                    for (var i = 0; i < this._dates.length; i++) {
                        outpValue += '' + this._dates.format(this.actualFormat) + this._options.multidateSeparator;
                    }
        ...
        DateTimePicker.prototype.daysOfWeekDisabled = function daysOfWeekDisabled(_daysOfWeekDisabled) {
            ...
            if (this._options.useCurrent && !this._options.keepInvalid) {
                for (var i = 0; i < this._dates.length; i++) {
                    var tries = 0;
                    while (!this._isValid(this._dates, 'd')) {
                        this._dates.add(1, 'd');
                        if (tries === 31) {
        ...
        DateTimePicker.prototype.maxDate = function maxDate(_maxDate) {
            ...
            for (var i = 0; i < this._dates.length; i++) {
                if (this._options.useCurrent && !this._options.keepInvalid && this._dates.isAfter(_maxDate)) {
        ...
        DateTimePicker.prototype.minDate = function minDate(_minDate) {
            ...
            for (var i = 0; i < this._dates.length; i++) {
                if (this._options.useCurrent && !this._options.keepInvalid && this._dates.isBefore(_minDate)) {
        ...
        DateTimePicker.prototype.locale = function locale(_locale) {
            ...
            for (var i = 0; i < this._dates.length; i++) {
                this._dates.locale(this._options.locale);
            }
        ...
        DateTimePicker.prototype.disabledHours = function disabledHours(hours) {
            ...
            if (this._options.useCurrent && !this._options.keepInvalid) {
                for (var i = 0; i < this._dates.length; i++) {
                    var tries = 0;
                    while (!this._isValid(this._dates, 'h')) {
                        this._dates.add(1, 'h');
                        if (tries === 24) {
