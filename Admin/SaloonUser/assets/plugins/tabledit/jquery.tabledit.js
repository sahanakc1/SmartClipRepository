            ...
            columns: {
                ...
                editable: function() {
                    for (var i = 0; i < settings.columns.editable.length; i++) {
                        var $td = $table.find('tbody td:nth-child(' + (parseInt(settings.columns.editable[0]) + 1) + ')');
                        ...
                        $td.each(function() {
                            ...
                            if (typeof settings.columns.editable[2] !== 'undefined') {
                                // Create select element.
                                var input = '<select class="tabledit-input ' + settings.inputClass + '" name="' + settings.columns.editable[1] + '" style="display: none;" disabled>';

                                // Create options for select element.
                                $.each(jQuery.parseJSON(settings.columns.editable[2]), function(index, value) {
                                    if (text === value) {
                                ...
                                var input = '<input class="tabledit-input ' + settings.inputClass + '" type="text" name="' + settings.columns.editable[1] + '" value="' + $(this).text() + '" style="display: none;" disabled>';
                            }
