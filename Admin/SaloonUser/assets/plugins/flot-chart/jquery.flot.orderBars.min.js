    ...
    function init(plot){
        ...
        function getAxeMinMaxValues(series,AxeIdx){
            ...
            for(var i = 0; i < series.length; i++){
                minMaxValues[0] = series.data[0][AxeIdx];
                minMaxValues[1] = series.data[series.data.length - 1][AxeIdx];
            }
            return minMaxValues;
        }
        ...
        function findOthersBarsToReOrders(series){
            ...
            for(var i = 0; i < series.length; i++){
                if(series.bars.order != null && series.bars.show){
        ...
        function sumWidth(series,start,end){
            ...
            for(var i = start; i <= end; i++){
                totalWidth += series.bars.barWidth+borderWidthInXabsWidth*2;
            }
