...
$.extend($.validator, {
	...
	prototype: {
		...
		checkForm: function() {
			this.prepareForm();
			for ( var i = 0, elements = (this.currentElements = this.elements()); elements; i++ ) {
				this.check( elements );
			}
			return this.valid(); 
		},
		...
		defaultShowErrors: function() {
			for ( var i = 0; this.errorList; i++ ) {
				var error = this.errorList;
			...
			if (this.settings.success) {
				for ( var i = 0; this.successList; i++ ) {
					this.showLabel( this.successList );
				}
			}
			if (this.settings.unhighlight) {
				for ( var i = 0, elements = this.validElements(); elements; i++ ) {
					this.settings.unhighlight.call( this, elements, this.settings.errorClass, this.settings.validClass );
				}
			}
